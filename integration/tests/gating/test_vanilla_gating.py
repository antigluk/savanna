...
from integration.configs import config as cfg
from integration.tests import cluster_configs
from integration.tests import edp
from integration.tests import map_reduce
from integration.tests import scaling
from integration.tests import swift
